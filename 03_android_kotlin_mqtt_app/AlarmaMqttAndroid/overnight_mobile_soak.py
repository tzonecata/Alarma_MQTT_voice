...
APP_DIR = Path("/home/ctone/Downloads/Personale_tz/Alarma_Mqtt/03_android_kotlin_mqtt_app/AlarmaMqttAndroid")
BASE_DIR = APP_DIR.parent
ADB = BASE_DIR / ".toolchain/android-sdk/platform-tools/adb"
        ...
        while time.time() < deadline:
            ...
            if connected:
                ...
                if total_cycles % 2 == 0:
                    ...
                    if publish_action == "publish-on-off":
                        publish_cycles += 1
                        if root is not None:
